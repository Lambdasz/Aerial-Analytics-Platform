...
| **`emit_job_progress`** *(Event Stream)*| Subprocess (Stdout) | **Module 3, 11** (Task Monitor) | Tauri Event: `app.emit("plugin://progress", JobProgress)` |
