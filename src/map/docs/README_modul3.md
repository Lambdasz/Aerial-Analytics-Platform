...
- `src-tauri/src/lib.rs` bagian crate docs (`## Project Brief` + `## Module N`) — deskripsi lengkap 11 modul Aerial Analytics Platform.
- [`RULES_MAP_FR.md`](../RULES_MAP_FR.md) / [`RULES_MAP_CONTROLLER.md`](../../../src-tauri/src/map_controller/RULES_MAP_CONTROLLER.md) — aturan detail per sisi.
